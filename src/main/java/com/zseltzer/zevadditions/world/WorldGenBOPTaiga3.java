    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        ...
        if (y >= 1 && y + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, (BlockBOPSapling) ModBlocks.saplings) &&
                        block2.canSustainPlant(world, x + 1, y - 1, z, ForgeDirection.UP, (BlockBOPSapling)ModBlocks.saplings) &&
                        block3.canSustainPlant(world, x - 1, y - 1, z, ForgeDirection.UP, (BlockBOPSapling)ModBlocks.saplings) &&
                        block4.canSustainPlant(world, x, y - 1, z + 1, ForgeDirection.UP, (BlockBOPSapling)ModBlocks.saplings) &&
                        block5.canSustainPlant(world, x, y - 1, z - 1, ForgeDirection.UP, (BlockBOPSapling)ModBlocks.saplings);
