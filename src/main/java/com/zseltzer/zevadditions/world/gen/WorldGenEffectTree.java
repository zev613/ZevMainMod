...
{
	private Block log = ModBlocks.lightLog;
	private Block leaves = ModBlocks.lightLeaves;
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) 
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block3.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockModLightSapling)ModBlocks.lightSapling);
