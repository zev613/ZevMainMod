...
{
	private static Block log = ModBlocks.lightLog;
	private static Block leaves = ModBlocks.lightLeaves;
	...
	boolean validTreeLocation()
	{
		...
		if (block == ModBlocks.lightForestGrass || block == ModBlocks.lightForestGrass) 
		{
			isSoil = true;
		}
