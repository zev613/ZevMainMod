...
public class WorldGenPalmTree1 extends WorldGenAbstractTree
{
    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        ...
        else
        {
            ...
            {
                buildBlock(world, x + ((int) Math.floor(xoff)), y + h, z + ((int) Math.floor(yoff)), ModBlocks.logs, 2);
                if(b == bMax - 1)
                {
    ...
    {
        buildBlock(world, x + 2, y - 1, z, ModBlocks.leaves, 2);
        buildBlock(world, x - 2, y - 1, z, ModBlocks.leaves, 2);
        buildBlock(world, x, y - 1, z + 2, ModBlocks.leaves, 2);
        buildBlock(world, x, y - 1, z - 2, ModBlocks.leaves, 2);

        buildBlock(world, x + 1, y, z, ModBlocks.leaves, 2);
        buildBlock(world, x - 1, y, z, ModBlocks.leaves, 2);
        buildBlock(world, x, y, z + 1, ModBlocks.leaves, 2);
        buildBlock(world, x, y, z - 1, ModBlocks.leaves, 2);
        buildBlock(world, x + 2, y, z + 2, ModBlocks.leaves, 2);
        buildBlock(world, x - 2, y, z - 2, ModBlocks.leaves, 2);
        buildBlock(world, x + 2, y, z - 2, ModBlocks.leaves, 2);
        buildBlock(world, x - 2, y, z + 2, ModBlocks.leaves, 2);

        buildBlock(world, x + 1, y + 1, z - 1, ModBlocks.leaves, 2);
        buildBlock(world, x - 1, y + 1, z + 1, ModBlocks.leaves, 2);
        buildBlock(world, x + 1, y + 1, z + 1, ModBlocks.leaves, 2);
        buildBlock(world, x - 1, y + 1, z - 1, ModBlocks.leaves, 2);
        buildBlock(world, x, y + 1, z, ModBlocks.leaves, 2);

        buildBlock(world, x + 2, y + 2, z, ModBlocks.leaves, 2);
        buildBlock(world, x - 2, y + 2, z, ModBlocks.leaves, 2);
        buildBlock(world, x, y + 2, z + 2, ModBlocks.leaves, 2);
        buildBlock(world, x, y + 2, z - 2, ModBlocks.leaves, 2);
    }
