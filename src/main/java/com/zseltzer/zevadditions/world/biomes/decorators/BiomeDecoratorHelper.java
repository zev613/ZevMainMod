...
import com.zseltzer.zevadditions.world.biomes.BiomeLightForest;
...
public class BiomeDecoratorHelper 
{
    ...
    protected static void decorateBiome(BiomeGenBase biome) 
    {
        ...
        {
            BiomeDecoratorMod.howManyTrees = BiomeLightForest.treesPerChunk;
            int i = BiomeDecoratorMod.howManyTrees;
            /** Chunk Postions **/
            int chunkX;
            int chunkZ;
            int y;
    ...
    private static void initOres() 
    {
        ...
        glowStone = new WorldGenMinable(Blocks.glowstone, 30, ModBlocks.lightStone);
    }
