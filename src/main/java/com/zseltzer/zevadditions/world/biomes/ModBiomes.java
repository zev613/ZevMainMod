package com.zseltzer.zevadditions.world.biomes;

import java.util.Random;

import com.zseltzer.zevadditions.init.ModBlocks;
import com.zseltzer.zevadditions.world.biomes.decorators.BiomeDecoratorMod;
...
/**
 * ZevAdditionsBiomes.class Holds and loads all ZevAdditions Biomes.
 * 
 * @author Zev613
 */
    ...
    public void genBiomeModdedTerrain(World world, Random random, Block[] replacableBlock, byte[] aByte, int x, int y, double z)
    {
        ...
        for (int l1 = 255; l1 >= 0; --l1)
        {
            ...
            else
            {
                ...
                {
                    if (block2 == ModBlocks.lightStone)
                    {
                        if (k == -1)
                        {
                            if (l <= 0)
