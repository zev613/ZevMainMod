...
public class WorldGenSacredOak extends WorldGenAbstractTree
{
    ...
    void generateLeafNode(int par1, int par2, int par3)
    {
        ...
        for (int var5 = par2 + leafDistanceLimit; var4 < var5; ++var4)
        {
            ...
            this.genTreeLayer(par1, var4, par3, var6, (byte)1, ModBlocks.leaves);
        }
    }
            ...
            for (int i = -2; i < 3; i++ )
            {
                ...
                for (int j = -2; j < 3; j++ )
                {
                    if (!(i == -2 && j == -2) && !(i == -2 && j == 2) && !(i == 2 && j == -2) && !(i == 2 && j == 2))
                    {
                        var5[2] = var4 + j;
                        var6[2] = var4 + j;
                        this.placeBlockLine(var5, var6, ModBlocks.logs);
                    }
                }
            }
        }
    ...
    void generateLeafNodeBases()
    {
        ...
        for (int[] var3 = new int[] {basePos[0], basePos[1], basePos[2]}; var1 < var2; ++var1)
        {
            ...
            {
                this.placeBlockLine(var3, var5, ModBlocks.logs);
            }
        }
    }
    ...
    int checkBlockLine(int[] par1ArrayOfInteger, int[] par2ArrayOfInteger)
    {
        ...
        else
        {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
            {
                ...
                if (block != Blocks.air && block != ModBlocks.leaves)
                {
                    break;
                }
            }
