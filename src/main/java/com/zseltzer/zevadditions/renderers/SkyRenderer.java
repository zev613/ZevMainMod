package com.zseltzer.zevadditions.renderers;
...
public class SkyRenderer extends IRenderHandler 
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) 
	{
		...
		mc.renderEngine.getTexture(new ResourceLocation("zevadditions:/textures/enviroment/sun.png")); 
		...
		mc.renderEngine.bindTexture(new ResourceLocation("zevadditions:/textures/enviroment/moon_phases.png"));
