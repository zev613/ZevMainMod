...
public class ItemGreenArrowCostume extends ItemArmor 
{
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if (boots != null && pants != null && chest != null)
			if (boots.getItem() == ModDCCostumes.greenArrowBoots && pants.getItem() == ModDCCostumes.greenArrowPants && chest.getItem() == ModDCCostumes.greenArrowChest && head.getItem() == ModDCCostumes.greenArrowHead)
			{
