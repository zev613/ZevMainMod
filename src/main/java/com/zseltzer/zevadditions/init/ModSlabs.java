...
public class ModSlabs 
{
	...
	public static String[] slabTypeNames = new String[] {"adobeBlock", "adobe_bricks", "adobeTile", "amethystBlock", "amethystOre", "andesite", "andesite_bricks", "andesite_smooth", "aquamarineBlock", "aquaStone", 
		...
		"endStone", "endStoneBricks", "fir_planks", "flintBlock", "gabbro", "gabbro_bricks", "gabbroPolishedBlock", "gabbroCobble", "glowstone", "goldBlock", "granite", "granite_bricks", "granite_smooth", "graniteCobble", "gravel", "gunpowderBlock", "hardenedClay", "hardenedClay_black", "hardenedClay_blue", 
		...
		"hardenedClay_orange", "hardenedClay_pink", "hardenedClay_purple", "hardenedClay_red", "hardenedClay_white", "hardenedClay_yellow", "hardenedDirt", "hardenedSand", "hardenedSandstone", "hardenedSandstone_bricks", "hardenedSandstoneCobble", "hardenedSandstonePolishedBlock", "hardenedIce", "hayVariant1", "ironBlock", "lapisBlock",
		"limeStone", "marble", "marble_bricks", "marblePolishedBlock", "marbleCobble", "melonBlock", "mudBlock", "mud_bricks", "mushroomBlock1", "mushroomBlock2", "mushroomBlock3", "mushroomBlock4",
