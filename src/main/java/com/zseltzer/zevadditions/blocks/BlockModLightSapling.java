...
public class BlockModLightSapling extends BlockSapling implements IGrowable
{
	...
	public BlockModLightSapling(String unlocalizedName)
	{
		// Set tree size.
		...
		this.setBlockName(unlocalizedName + "Sapling");
		this.setBlockTextureName(unlocalizedName + "_sapling");
	}
	...
	{
		if (meta < 0 || meta >= BlockModLightLeaves.typeNames.length)
		{
			meta = 0;
		}
	...
	public boolean isValidPosition(World world, int x, int y, int z, int metadata)
	{
		...
		{
		default:
			return block == ModBlocks.lightForestGrass || block == ModBlocks.lightForestDirt || block.canSustainPlant(world, x, y - 1, z, ForgeDirection.UP, this);
		}
	}
