...
public class BlockCherryTreeLeaves extends BlockLeavesBase implements IShearable 
{
    ...
    public BlockCherryTreeLeaves(String name) 
    {
        ...
        this.setBlockTextureName("zevadditions:" + name + "_leaves");
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) 
    {
        ...
        if (10 - chance >= 0) 
        {
            if (ModItems.cherry.isPresent()) 
            {
                ret.add(new ItemStack(ModItems.cherry.get()));
            }
            return ret;
        }
        if (30 - chance >= 0) 
        {
            if (ModBlocks.cherryTreeSapling.isPresent()) 
            {
                ret.add(new ItemStack(ModBlocks.cherryTreeSapling.get()));
                return ret;
            }
        }
        return ret;
