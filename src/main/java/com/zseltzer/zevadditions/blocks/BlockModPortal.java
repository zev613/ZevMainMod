...
import com.zseltzer.zevadditions.util.LightDimensionTeleporter;
import com.zseltzer.zevadditions.world.DimensionIDs;
...
public class BlockModPortal extends BlockBreakable
{
	...
	{
		super("zevadditions:" + name, Material.portal, false);
	...
	public static class Size
	{
		...
		{
			return block.getMaterial() == Material.air || /*block == ModBlocks.lightFire ||*/ block == ModBlocks.lightPortal;
		}
