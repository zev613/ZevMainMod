...
public class BlockModFire extends BlockFire
{
    ...
    protected BlockModFire(String name)
    {
        ...
        this.setBlockTextureName("zevadditions:" + name);
    ...
    {
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.planks), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.double_wooden_slab), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.wooden_slab), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.fence), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.oak_stairs), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.birch_stairs), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.spruce_stairs), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.jungle_stairs), 5, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.log), 5, 5);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.log2), 5, 5);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.leaves), 30, 60);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.leaves2), 30, 60);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.bookshelf), 30, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.tnt), 15, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.tallgrass), 60, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.double_plant), 60, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.yellow_flower), 60, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.red_flower), 60, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.wool), 30, 60);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.vine), 15, 100);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.coal_block), 5, 5);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.hay_block), 60, 20);
        Blockss.lightFire.func_149842_a(getIdFromBlock(Blocks.carpet), 60, 20);
    }
    ...
    public void onBlockAdded(World world, int x, int y, int z){
        if (world.provider.dimensionId > 0 || !ModBlocks.lightPortal.getPortalSize(world, x, y, z)){
            if (!World.doesBlockHaveSolidTopSurface(world, x, y - 1, z) && !this.canNeighborBurn(world, x, y, z)){
                world.setBlockToAir(x, y, z);
            } else {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_) && !Blockss.lightFire.canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP))
        {
