...
public class ItemStarSapphireCostume extends ItemArmor 
{
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if (boots != null && pants != null && chest != null)
			if (boots.getItem() == ModDCCostumes.starSapphireBoots && pants.getItem() == ModDCCostumes.starSapphirePants && chest.getItem() == ModDCCostumes.starSapphireChest && head.getItem() == ModDCCostumes.starSapphireHead)
            {
