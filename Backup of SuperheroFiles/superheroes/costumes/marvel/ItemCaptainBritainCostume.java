...
public class ItemCaptainBritainCostume extends ItemArmor 
{
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if (boots != null && pants != null && chest != null)
			if (boots.getItem() == ModMarvelCostumes.captainBritainBoots && pants.getItem() == ModMarvelCostumes.captainBritainPants && chest.getItem() == ModMarvelCostumes.captainBritainChest && head.getItem() == ModMarvelCostumes.captainBritainHead)
            {
